...
\begin{figure} 
  ...
  \subfloat[]{%
    ...
    \label{1a}
  \subfloat[]{%
        \includegraphics[width=0.7\linewidth,valign=c]{graph1.jpg}}
    \label{1b}
  \caption{(a) sample image (b) class score from our design and 32-bit implementation}
  \label{fig1} 
\end{figure}
